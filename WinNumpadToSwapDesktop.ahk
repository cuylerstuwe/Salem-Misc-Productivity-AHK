; Edited from original author's script to use numpad instead of number row
...
RunHotkey:
	switchToDesktop(StrReplace(A_ThisHotkey, "#NumPad", , , 1) - 1)
return
...
main()
{
	...
	Loop 9
		Hotkey, #NumPad%A_Index%, RunHotkey
	return
